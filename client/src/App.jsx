...
import CheckoutPage from "./Components/Checkout2/CheckoutPage";
//CONTEXT IMPORT
      ...
      <>
        ...
        <Routes>
          ...
          <Route
            ...
            element={<ForgotPassword hostlink={hostLink} />}
          />
          <Route
            path="/my-zf"
            element={
          ...
          <Route
            exact
            path="/admin"
            element={<AdminLogin hostlink={hostLink} />}
          />
          <Route
            exact
            path="/admin-register"
            element={<AdminRegister hostlink={hostLink} />}
          />
          <Route
            exact
            path="/dashboard"
            element={<AdminDashboard hostlink={hostLink} />}
          />
