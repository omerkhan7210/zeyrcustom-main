  ...
  return (
    <>
      ...
      >
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" for="AddressCityNew">
            City
          </label>
          <input
            type="text"
        ...
        <div>
          <label class="visually-hidden" for="AddressCountryNew">
            Country/region
          </label>
          <div class="select">
            <select
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" for="AddressZipNew">
            Postal/ZIP code
          </label>
          <input
            type="text"
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" for="AddressPhoneNew">
            Phone
          </label>
          <input
            type="tel"
        ...
        <div>
          ...
          <button
            class="btn btn--unstyled link-styled"
            type="reset"
