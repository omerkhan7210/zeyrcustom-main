...
return (
  <div id="shopify-section-footer" className="shopify-section">
    ...
    <footer className="site-footer color-schema-1 site-footer--border">
      <div className="footer__inner">
        <div className="footer__inner-top">
          ...
          <div className="footer__inner-top-right">
            <div className="flex">
              <div className="footer__localization-wrapper flex flex--gap jcb">
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="return_to"
                    value="/en-pk/collections/womens-autumn-winter-2023-collection/products/women-ma-1-white-black"
                  />
                  <h2 className="visually-hidden" id="FooterCountryLabel">
                    Country/region
                  </h2>
              ...
              {/* <div className="accessibility-link-container flex">
                <a
                  ...
                  className="accessibility-link link-styled"
                >
                  <svg
            ...
            {/* <a className="ot-sdk-show-settings link-styled--reverse">
              Cookies Settings
            </a> */}
            <div className="location-notify">
              <p>
                Don't see your country? Signup to receive updates when it's
                available.{" "}
                <a
                  href="/en-pk/pages/amiri-launching-in-your-country"
                  title="Amiri launching in your country"
                >
                  Notify Me
                </a>
              </p>
        ...
        <div className="footer__blocks-wrapper flex jcb flex--mobile">
          <div className="footer__blocks flex flex--mobile">
            <div className="footer-block">
              <div
                className="footer-block__disclosure mobile--only details--active"
                open=""
              >
                <summary
                  className="flex jcb aic footer__heading"
                  aria-label="Toggle ABOUT ZEYR FINERI"
                  role="button"
                  aria-controls="footer-block-link_list"
                  aria-expanded="true"
                >
                  ABOUT ZEYR FINERI<span className="details__icon"></span>
                </summary>
                <div id="footer-block-link_list">
                  <ul className="footer-block__linklist list-unstyled">
                    <li>
                      <a
                        href="/en-pk/pages/stores"
                        className="menu-item link-styled"
                      >
                        Retail Locations
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        href="https://jobs.lever.co/AMIRI"
                        className="menu-item link-styled"
                      >
                        Careers
                      </a>
                    ...
                    <li>
                      <a
                        href="https://www.farfetch.com/shopping/Men/boutique-amiri/items.aspx"
                        className="menu-item link-styled"
                      >
                        FARFETCH
                      </a>
            ...
            <div className="footer-block">
              ...
              >
                <summary
                  className="flex jcb aic footer__heading"
                  aria-label="Toggle Client services"
                  role="button"
                  aria-controls="footer-block-link_list"
                  aria-expanded="true"
                >
                  Client services<span className="details__icon"></span>
                </summary>
                <div id="footer-block-link_list">
                  <ul className="footer-block__linklist list-unstyled">
                    <li>
            ...
            <div className="footer-block">
              ...
              >
                <summary
                  ...
                  aria-expanded="true"
                >
                  Connect<span className="details__icon"></span>
                </summary>
                <div id="footer-block-link_list">
                  <ul className="footer-block__linklist list-unstyled">
                    <li>
                    ...
                    <li>
                      <a
                        href="https://www.facebook.com/amirilosangeles"
                        className="menu-item link-styled"
                      >
                        Facebook
                      </a>
                    ...
                    <li>
                      <a
                        href="https://www.instagram.com/amiri/?hl=en"
                        className="menu-item link-styled"
                      >
                        Instagram
                      </a>
        ...
        <div
          className="footer__social-wrapper flex flex--gap flex--mobile jcb"
          style={{ gap: "1.5rem" }}
        ></div>
        <img
          className="footer__logo"
          src="/cdn/shop/files/monogram_efda229b-3c71-4da6-b40c-1fac6bd4089f.png?v=1678302624&amp;width=360"
          alt="AMIRI"
        />
      </div>
    </footer>
