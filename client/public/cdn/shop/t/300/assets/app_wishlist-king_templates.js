...
Line 200:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 201:8 Transforming const to the configured target environment ("es5") is not supported yet
...
const templates = [{
    ...
    },
    {
        id: "wishlist-icon",
        template: `
    <svg class="icon--wishlist" width="15" height="20" viewBox="0 0 15 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.79776 15.7977L0.527344 19.1641V0.5H13.5273V19.1633L7.27114 15.7979L7.0345 15.6706L6.79776 15.7977Z" stroke="black" stroke-miterlimit="10"/></svg>
    `,
    },
    {
        id: "remove-icon",
